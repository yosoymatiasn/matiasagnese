...
export function NavigationLink({
	...
	return (
		...
		>
			...
			>
				<span className="flex items-center justify-center w-4 text-2xl">
					<Icon />
				</span>
				<span className="flex-1">{label}</span>
				{Accessory && (
					<span className="flex items-center justify-center w-4 text-black text-opacity-40 dark:text-white text-2xl">
						<Accessory />
					</span>
				)}
			</Link>
